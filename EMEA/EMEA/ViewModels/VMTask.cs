...
namespace EMEA.ViewModels
{
    public class VMTask : ITDTask
    {
        public async Task<bool> AddTask(TodoTask tdtask)
        {
            ...
            client.BaseAddress = new Uri(BaseUrl.strUrl + "TDTask/addtask");
        ...
        public async Task<bool> DeleteTask(int taskId)
        {
            ...
            client.BaseAddress = new Uri(BaseUrl.strUrl + "TDTask/delete/" + taskId);
        ...
        public async Task<bool> DoneChange(int taskid, TodoTask tdtask)
        {
            ...
            StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
            HttpClient client = new HttpClient();
            client.BaseAddress = new Uri(BaseUrl.strUrl + "TDTask/done/" + taskid);
        ...
        public async Task<List<TodoTask>> GetTask(int mainid)
        {
            ...
            //
            var client = new HttpClient();
            client.BaseAddress = new Uri(BaseUrl.strUrl + "TDTask/" + mainid);
        ...
        public async Task<bool> TaskNameChange(int taskid, TodoTask tdtask)
        {
            ...
            StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
            HttpClient client = new HttpClient();
            client.BaseAddress = new Uri(BaseUrl.strUrl + "TDTask/editname/" + taskid);
            HttpResponseMessage responseMessage = await client.PutAsync("", content);
            if (responseMessage.IsSuccessStatusCode)
            {
                return await Task.FromResult(true);
